...
public class transactionORM {
    ...
    public transactionORM() {
    }
    public transactionORM(Integer idMaster, Integer idCode, String trans, String price, String national_code, String data, String time, String state, String json, String range) {
