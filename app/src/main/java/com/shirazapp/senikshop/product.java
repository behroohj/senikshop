...
public class product {
    ...
    public product(Integer idMaster,String title,String content, String image,Integer commission,Integer stock,Integer price,Integer percent,Integer product_head,Integer shop,Integer number,Boolean trash) {
